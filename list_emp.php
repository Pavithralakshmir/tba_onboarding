...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
   ...
   <div class="card">
                        ...
                        <div class="text-center">
                            <!--begin::Title-->
                            <h3 class="fs-2hx text-dark mt-8">Edit And Delete Employee's Details</h3>
                            <!--end::Title-->
                        </div>
                        <!--end::Card header-->
                        <!--begin::Card body-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-cenetr min-w-70px">Designation</th>
                                        <th class="text-cenetr min-w-70px">Role</th>
                                    </tr>
                                    <!--end::Table row-->
                                </thead>
                                <!--end::Table head-->
                                ...
                                <tbody class="fw-bold text-gray-600 ui-sortable">
                                    <?php
                                    $i = 1;
                                    $sql = "SELECT * FROM `users` where `is_active`='0' && `role`!='client'";
                                    ...
                                    ?>
                                        <tr id="<?php echo $row['id']; ?>">
                                            ...
                                            <!--begin::Action=-->
                                            <td>
                                                <a href="add_tba_service_category.php?<?php echo $action_string . '=' . $edit_string . '&' . $id_string . '=' . $id; ?>" class="menu-link px-3">Edit</a>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app_<?php echo $row['id']; ?>">View</a>
                                        ...
                                        <div class="modal fade" id="kt_modal_create_app_<?php echo $row['id']; ?>" tabindex="-1" aria-hidden="true">
                                            <!--begin::Modal dialog-->
                                                        ...
                                                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                                                            ...
                                                            <div class="me-7 mb-4">
                                                                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                                                    <img src="<?php echo $row['inst']; ?>" alt="image" />
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                                                    ...
                                                                    <div class="d-flex flex-column">
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-2">
                                                                            <a class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1"><?php echo $row['name']; ?></a>
                                                                            <a>
                                                                            ...
                                                                            <a class="btn btn-sm btn-light-success fw-bolder ms-2 fs-8 py-1 px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan"><?php echo $row['ecode']; ?></a>
                                                                        </div>
                                                                        <!--end::Name-->
                                                                        <!--begin::Info-->
                                                                        <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                                                            <a class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                                                                ...
                                                                                <!--end::Svg Icon--><?php echo $row['designation']; ?>
                                                                            </a>
                                                                            <a class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                                                                ...
                                                                                <!--end::Svg Icon--><?php echo $row['team']; ?>
                                                                            </a>
                                                                            <a class="d-flex align-items-center text-gray-400 text-hover-primary mb-2">
                                                                                ...
                                                                                <!--end::Svg Icon--><?php echo $row['pemail']; ?>
                                                                            </a>
                                                                        </div>
                                                                        <!--end::Info-->
                                                                    </div>
