...
$announcement_sql = "SELECT * FROM `tba_announcement` where live_date <= CURDATE() and last_date >= CURDATE() and `is_active`='0' and `is_delete`='0' ORDER BY `id` desc";
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper" style="padding-top:unset;">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="post d-flex flex-column-fluid" id="kt_post">
                        <!--begin::Container-->
                        <div id="kt_content_container" class="container-xxl mt-20">
                            <!--begin::Row-->
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="card card-xl-stretch mb-xl-8">
                                        ...
                                        <div class="card-header border-0">
                                            <h3 class="card-title fw-bolder text-dark">Recent Announcement</h3>
                                            ...
                                            ?>
                                                    ...
                                                    <div class="d-flex align-items-center mb-7">
                                                        ...
                                                        <div class="symbol symbol-30px me-5">
                                                            <img src="assets/media/icons/msg_icon_1.png">
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Text-->
                                                        <div class="flex-grow-1">
                                                            <a class="text-dark fw-bolder text-hover-primary fs-6 announcement_text"><?php echo $row['title']; ?></a>
                                                            <span class="text-muted d-inline fw-bold"><i class="bi bi-caret-right-square-fill"></i></span>
                                                    ...
                                                    <!--end::Item-->
                                                <?php }
                                            } else { ?> <p class="text-gray text-center m-auto">No Announcement </p> <?php } ?>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                    <!--end::List Widget 2-->
