...
if (isset($_GET['Tmd3ZFVwaCtxWmNsYU1UODJWaUYxUT09'])) {
    ...
    if ($action == 'edit') {
        ...
        $sql = "UPDATE `tba_service_category` SET `status` = '1' where id='$id'";
        $result = mysqli_query($conn, $sql);
        $sql = "UPDATE `tba_service_category` SET `status` = '1' where `parent`='$id'";
        $result = mysqli_query($conn, $sql);
        header("Location: add_tba_service_category.php?msg=3");
    } else if ($action == 'active') {
        $sql = "UPDATE `tba_service_category` SET `status` = '0' where id='$id'";
        $result = mysqli_query($conn, $sql);
        header("Location: add_tba_service_category.php?msg=3");
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Add TBA Service Category</h1>
                                <!--end::Title-->
                                <!--begin::Separator-->
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="breadcrumb-item text-dark">Add TBA Service Category</li>
                                    <!--end::Item-->
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                        ...
                        <div id="kt_content_container" class="container-xxl">
                            ...
                            <div class="card">
                                ...
                                <div class="text-center">
                                    <!--begin::Title-->
                                    <h3 class="fs-2hx text-dark mt-8">Add TBA Service Category Form</h3>
                                    <!--end::Title-->
                                </div>
                                <!--end::Card header-->
                                <!--begin::Card body-->
                                <div class="card-body pt-0">
                                    <!--begin::Form-->
                                    <form class="form mb-15" role="form" method="POST" enctype="multipart/form-data" id="add_new_category">
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-6 fv-row">
                                                <!--begin::Label-->
                                                <label class="required fs-5 fw-bold mb-2">Add Category</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                            ...
                                            <div class="col-md-6 fv-row">
                                                <div class="text-center pt-8">
                                                    ...
                                                    <button type="submit" class="btn btn-success" id="add_new_category_submit_button" name="add_new_category_submit">
                                                        <!--begin::Indicator-->
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 diagnosis_list" id="kt_customers_table">
                                        ...
                                        <tbody class="fw-bold text-gray-600 ui-sortable">
                                            <?php
                                            $i = 1;
                                            $sql = "SELECT * FROM `tba_service_category` where `is_active`='0' ORDER BY `position` asc";
                                            $result = mysqli_query($conn, $sql);
                                            while ($row = mysqli_fetch_assoc($result)) {
