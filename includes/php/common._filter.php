      ...
      <div class="card-body p-lg-7">
          ...
          <div class="row mb-5 text-center">
              ...
              <div class="col-md-4 fv-row">
                  ...
                  <!--end::Label-->
                  <!--begin::Input-->
                  <select name="sd_status" id="sd_status" data-control="select2" data-placeholder="Select a Status..." class="form-select form-select-solid">
              ...
              <div class="col-md-4 fv-row">
                  <!--begin::Label-->
                  <label class="required fs-5 fw-bold mb-2">Date Range Picker</label>
                  <!--end::Label-->
                  <!--begin::Input-->
                  <!--begin::Daterangepicker(defined in src/js/layout/app.js)-->
                  <div data-kt-daterangepicker="true" id="sd_daterangepicker" data-kt-daterangepicker-opens="left" class="btn btn-sm btn-light d-flex align-items-center px-4">
                      <!--begin::Display range-->
              ...
              <div class="col-md-4 fv-row">
                  <!--begin::Label-->
                  <label class="fs-5 fw-bold mb-1"></label>
                  <!--end::Label-->
                  <!--begin::Toolbar-->
