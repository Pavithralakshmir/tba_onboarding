...
include 'includes/php/common_actions.php';
?>
...
<head>
    <title>TBA - Requested services</title>
    <meta charset="utf-8" />
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper" style="padding-top:unset;">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        <?php include 'includes/php/common._filter.php'; ?>
                        <!--begin::Card-->
                        <div class="card">
                            <!--begin::Body-->
                            <div class="card-body p-lg-7">
                                <div id="getstatus" class="text-center"></div>
                            </div>
                            <!--end::Body-->
                        </div>
                        <!--end::Card-->
...
<script>
    var frompage = "requested_services.php";
</script>
<?php include_once 'includes/js/common_report_script.php'; ?>
